    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConversationDigests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConversationDigests_Conversations_ConversationId",
                        column: x => x.ConversationId,
                        principalTable: "Conversations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConversationDigests_Messages_FirstMessageId",
                        column: x => x.FirstMessageId,
                        principalTable: "Messages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConversationDigests_Messages_LastMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationDigests_ConversationId",
                table: "ConversationDigests",
                column: "ConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationDigests_FirstMessageId",
                table: "ConversationDigests",
                column: "FirstMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationDigests_LastMessageId",
                table: "ConversationDigests",
